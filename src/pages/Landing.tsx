...
const FEATURES = [
  {
    ...
    fgColor: '#7c3aed',
    icon: (
      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
    ),
  },
  {
    ...
    fgColor: '#4f46e5',
    icon: (
      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" /><path d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    ),
  },
  {
    ...
    fgColor: '#d97706',
    icon: (
      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>
    ),
  },
  {
  ...
  },
  {
    ...
    fgColor: '#0284c7',
    icon: (
      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    ),
  },
  {
    ...
    fgColor: '#db2777',
    icon: (
      <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
    ),
  },
]
...
export default function Landing() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: '#1E293B', background: '#FAFAFC' }}>
            ...
            {NAV_ITEMS.map((item) => (
              <button
                ...
                style={{
                  ...
                  fontSize: 14, fontWeight: 600, color: item.id === 'beranda' ? '#7c3aed' : '#64748b',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                background: '#7c3aed', borderRadius: 9999, border: 'none', cursor: 'pointer',
                boxShadow: '0 4px 14px rgba(124,58,237,0.2)',
                transition: 'all 0.2s',
              }}
            >
      ...
      <main>
        {/* ═══════ HERO ═══════ */}
        <section id="beranda" style={{ position: 'relative', paddingTop: 32, paddingBottom: 64, overflow: 'hidden' }}>
          {/* Background glow */}
          <div style={{
            position: 'absolute', top: '25%', left: '50%', transform: 'translateX(-50%)',
            width: 700, height: 350, borderRadius: '50%',
            background: 'rgba(221,214,254,0.4)', filter: 'blur(130px)',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '7fr 5fr', gap: 48, alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24, alignItems: 'flex-start' }}>
                ...
                <div style={{
                  ...
                  background: '#f5f3ff', border: '1px solid rgba(221,214,254,0.7)',
                ...
                <h1 style={{
                  ...
                  lineHeight: 1.12, letterSpacing: -0.5, margin: 0,
                }}>
                ...
                <p style={{ fontSize: 17, color: '#64748b', lineHeight: 1.7, maxWidth: 520, margin: 0 }}>
                  ...
                  Matematika, Sains, dan Bahasa dengan visual yang seru, adaptif, dan tidak membosankan.
                </p>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, paddingTop: 8 }}>
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 700, color: '#fff', background: '#7c3aed',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 700, color: '#334155', background: '#fff',
                ...
                {/* Social Proof */}
                <div style={{
                  paddingTop: 16, display: 'flex', alignItems: 'center', gap: 16,
                  borderTop: '1px solid rgba(226,232,240,0.6)', width: '100%', maxWidth: 420,
                }}>
                  ...
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: '#fbbf24', fontSize: 12 }}>
                      {'★★★★★'}
                      <span style={{ color: '#1e293b', fontWeight: 700, fontSize: 14, marginLeft: 4 }}>4.9/5</span>
                    </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', position: 'relative' }}>
                <div style={{
                  width: '100%', maxWidth: 420, borderRadius: 24, padding: 12,
                  background: 'linear-gradient(180deg, rgba(237,233,254,0.6), rgba(255,255,255,0.8))',
                  border: '1px solid #ede9fe',
                  boxShadow: '0 25px 60px -12px rgba(0,0,0,0.08)',
                }}>
                  <div style={{
                    position: 'relative', borderRadius: 16, overflow: 'hidden',
                    background: '#fff', aspectRatio: '4/4.5',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>
                    <img
                    ...
                    <div style={{
                      ...
                      <div>
                        <p style={{ fontSize: 11, fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1, margin: 0 }}>
                          Pencapaian Siswa
                        </p>
                        <p style={{ fontSize: 16, fontWeight: 800, color: '#1e293b', margin: '2px 0 0' }}>
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={s.label} style={{
                    ...
                    <span style={{ fontSize: 36, fontWeight: 800, color: '#7c3aed' }}>{s.value}</span>
                    <span style={{
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
            ...
            <div style={{ textAlign: 'center', maxWidth: 720, margin: '0 auto 64px' }}>
              <span style={{
                ...
                color: '#7c3aed', textTransform: 'uppercase', letterSpacing: 2,
                background: '#f5f3ff', padding: '4px 14px', borderRadius: 9999,
                border: '1px solid #ede9fe',
              }}>
                Keunggulan Belajar
              </span>
              ...
              <p style={{ fontSize: 16, color: '#64748b', lineHeight: 1.7, marginTop: 12 }}>
                ...
                <div key={f.title} style={{
                  ...
                  <div>
                    <div style={{
                      ...
                      background: f.bgColor, color: f.fgColor,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      marginBottom: 20,
                    }}>
                      {f.icon}
                  ...
                  <div style={{
                    ...
                    fontSize: 13, fontWeight: 600, color: f.fgColor,
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
              ...
              <div>
                <span style={{
                  ...
                  color: '#7c3aed', textTransform: 'uppercase', letterSpacing: 2,
                  background: '#f5f3ff', padding: '4px 14px', borderRadius: 9999,
                  border: '1px solid #ede9fe', marginBottom: 12,
                }}>
                  Alur Sederhana
                </span>
                <h2 style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  {STEPS.map(s => (
                    <div key={s.n} style={{
                      ...
                      borderRadius: 16, background: 'rgba(248,250,252,0.8)',
                      border: '1px solid #f1f5f9',
                      ...
                      <div>
                        ...
                        <h3 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '2px 0 4px' }}>
                          {s.title}
                        </h3>
                        <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.7, margin: 0 }}>
                          {s.desc}
              ...
              <div style={{
                ...
                <div style={{ position: 'absolute', bottom: 24, left: 24, right: 24, color: '#fff' }}>
                  ...
                  <h4 style={{ fontSize: 20, fontWeight: 700, margin: '0 0 4px' }}>
                    Membangun Rasa Percaya Diri Sejak Dini
                  </h4>
                  <p style={{ fontSize: 14, color: '#cbd5e1', margin: 0, lineHeight: 1.6 }}>
                    94% orang tua merasakan peningkatan fokus dan nilai raport anak setelah 30 hari.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
            <div style={{
              ...
              <div style={{ position: 'relative', zIndex: 1, maxWidth: 640, margin: '0 auto' }}>
                <h2 style={{
                  fontSize: 40, fontWeight: 800, lineHeight: 1.2, margin: '0 0 16px',
                }}>
                  Siap Buat Belajar Lebih Menyenangkan?
                </h2>
                <p style={{ fontSize: 17, color: '#ddd6fe', margin: '0 0 32px', lineHeight: 1.7 }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 700, color: '#7c3aed', background: '#fff',
                      border: 'none', cursor: 'pointer',
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
          <div style={{
            display: 'grid', gridTemplateColumns: '4fr 2fr 2fr 4fr',
            ...
            <div>
              ...
              <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.7, maxWidth: 300, margin: 0 }}>
            ...
            {/* Navigasi */}
            <div>
              <h4 style={{ fontSize: 12, fontWeight: 700, color: '#0f172a', textTransform: 'uppercase', letterSpacing: 1, margin: '0 0 14px' }}>
                Navigasi
              </h4>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  ...
                  <li key={l.label}>
                    <button
                      type="button"
                      onClick={() => l.route ? navigate(l.route) : scrollTo(l.id!)}
                      style={{
                        background: 'none', border: 'none', cursor: 'pointer',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 20 }}>
              ...
              {/* Facebook */}
              <a href="#" style={{ color: '#94a3b8', transition: 'color 0.2s' }}>
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.556 5 15.658 5H18V0h-3.808C10.595 0 9 1.583 9 4.615V8z" /></svg>
              </a>
            </div>
          </div>
        </div>
