    ...
    <div className='home-page'>
      <div className='home-inner auth-form-page'>
        ...
        <div className='auth-demo-hint'>
          <p className='auth-demo-hint-title'>
            🔑 Akun demo (setelah backend di-seed):
          </p>
          <p>
            <strong>👩‍🏫 Operator:</strong> operator@sekolah.id / operator12345
          </p>
          <p>
            <strong>🧑‍🎓 Murid:</strong> murid@sekolah.id / murid12345
          </p>
        </div>
      </div>
    </div>
