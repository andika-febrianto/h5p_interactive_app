...
export default function ChildDashboard() {
  ...
  const sideItems: {
    ...
    { key: 'home', label: 'Beranda', icon: '🏠' },
    {
      ...
      icon: '🚀',
      badge:
        assignments.filter((a) => a.status !== 'completed').length || undefined,
    },
  ...
  const getTaskStatusLabel = (a: ParentAssignment) => {
    ...
    const isCompleted =
      progress.total > 0 && progress.completed === progress.total
    if (isCompleted)
      return { label: 'Selesai 100%', color: 'text-emerald-600 font-bold' }
    if (a.status === 'overdue')
      return { label: 'Terlambat', color: 'text-red-600 font-bold' }
    if (progress.pct > 0)
      return { label: `${progress.pct}%`, color: 'text-indigo-600 font-bold' }
              ...
              >
                {[
                  ...
                  <div
                    ...
                    /* @ts-ignore */ onMouseEnter={(e: any) =>
                      (e.currentTarget.style.borderColor = kpi.hoverBorder)
                    }
                    onMouseLeave={(e: any) =>
                        ...
                        return (
                          <div
                            ...
                            style={{
                              border: isCompleted
                                ? '1px solid #f1f5f9'
                                : `1px solid ${a.status === 'overdue' ? '#FCA5A5' : progress.pct > 0 ? '#C7D2FE' : '#e2e8f0'}`,
                            ...
                            >
                              ...
                              <div>
                                ...
                                {isCompleted && (
                                  ...
                                  >
                                    Nilai: {Math.round(progress.pct * 1.05)}/100
                                    ·{' '}
                                    {progress.pct >= 80
                                      ? 'Fantastis!'
                                      : 'Bagus!'}
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontWeight: (item as any).fontWeight || 600,
                          fontSize: 13,
                          color: (item as any).color || '#0f172a',
                        }}
                      >
                        {item.value}
                      </span>
