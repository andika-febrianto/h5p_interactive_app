...
export default function ChildDashboard() {
  ...
  const filteredAssignments = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      result = result.filter((a) => {
        ...
        return (
          (mod?.title || a.title || '').toLowerCase().includes(q) ||
          getSubjectName(mod?.subjectId).toLowerCase().includes(q)
        )
      })
    }
  ...
  const subjectGroups = useMemo(() => {
    ...
    assignments.forEach((a) => {
      const mod = a.materialId ? moduleCache[a.materialId] : null
      const n = getSubjectName(mod?.subjectId) || 'Tugas'
      g[n] = (g[n] || 0) + 1
    })
    return g
  }, [assignments, moduleCache])
  ...
  const sideItems: {
    ...
    { key: 'home', label: 'Beranda', icon: '🏠' },
    {
      ...
      label: 'Misi Belajar',
      icon: '🚀',
      badge: activeMissions || undefined,
    },
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            >
              <span style={{ fontSize: 16 }} className='animate-bounce'>
                🔥
              </span>
        ...
        >
          <div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      textAlign: 'left',
                      boxShadow: isActive
                        ? '0 8px 20px rgba(88,80,236,0.2)'
                        : 'none',
                    }}
                    className={
                      !isActive
                        ? 'hover:bg-white hover:text-[#5850EC] hover:border-slate-100'
                        : ''
                    }
                    onMouseEnter={(e) => {
                      if (!isActive) {
            ...
            >
              ...
              <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 12px' }}>
                Paket Pro 14 Hari berakhir dalam 9 hari lagi.
              </p>
              <button
                type='button'
                style={{
          ...
          >
            ...
            <p style={{ fontSize: 11, color: '#94a3b8', margin: '2px 0 8px' }}>
              Pantau waktu layar & limit nilai
            </p>
            <span
              data-hover-text
              style={{
            ...
            <>
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      ·{' '}
                      <span style={{ color: '#5850EC', fontWeight: 600 }}>
                        Kelas {user?.grade ?? '?'} SD
                      </span>{' '}
                      · Siap menaklukkan misi belajarmu hari ini?
                    </p>
                  </div>
                  <div
                    style={{
                      ...
                      gap: 8,
                      background:
                        'linear-gradient(90deg, rgba(245,158,11,0.1), rgba(99,102,241,0.1))',
                  ...
                  >
                    ...
                    >
                      Target Hari Ini:{' '}
                      <strong>{activeMissions} Misi Lagi</strong>
                    </span>
                  </div>
                </div>
                <div
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    sub: `/ ${assignments.length || 0} Misi`,
                    badge: `${assignments.length > 0 ? Math.round((completedCount / assignments.length) * 100) : 0}%`,
                    badgeBg: '#ECFDF5',
                    badgeColor: '#065F46',
                    hover: '#6EE7B7',
                  },
                  {
                    ...
                    value: `+${totalPoints}`,
                    sub: 'XP',
                    badge: totalPoints > 0 ? 'Naik Level!' : 'Mulai!',
                    badgeBg: '#EEF2FF',
                    badgeColor: '#4338CA',
                    hover: '#A5B4FC',
                    valueColor: '#5850EC',
                  },
                  {
                    icon: '⏱️',
                    label: 'Waktu Belajar',
                    value: `${inProgressCount * 15 + completedCount * 10}`,
                    sub: 'Menit',
                    badge: 'Fokus',
                    badgeBg: '#F5F3FF',
                    badgeColor: '#6D28D9',
                  ...
                  <div
                    ...
                    /* @ts-ignore */
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.borderColor = kpi.hover)
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.borderColor = '#f1f5f9')
                    }
                  >
                    ...
                    <div
                      style={{
                        fontSize: 22,
                        fontWeight: 800,
                        color: (kpi as any).valueColor || '#0f172a',
                        marginTop: 2,
                        display: 'flex',
                        alignItems: 'baseline',
                        gap: 4,
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      Selesaikan tugas interaktif untuk raih koin bintang &
                      trofi
                    </p>
                  </div>
                  <div
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        border: 'none',
                        background:
                          subjectFilter === 'all' ? '#fff' : 'transparent',
                        color: subjectFilter === 'all' ? '#0f172a' : '#64748b',
                        fontWeight: subjectFilter === 'all' ? 700 : 600,
                        cursor: 'pointer',
                        fontSize: 12,
                        boxShadow:
                          subjectFilter === 'all'
                      ...
                      .map(([name, count]) => (
                        <button
                          ...
                          style={{
                            ...
                            border: 'none',
                            background:
                              subjectFilter === name ? '#fff' : 'transparent',
                            color:
                              subjectFilter === name ? '#0f172a' : '#64748b',
                            fontWeight: subjectFilter === name ? 700 : 600,
                            cursor: 'pointer',
                            fontSize: 12,
                            boxShadow:
                              subjectFilter === name
                    ...
                    {filteredAssignments
                      ...
                      .map((a) => {
                        ...
                        if (isCompleted) {
                          ...
                          cardBg = 'rgba(254,242,242,0.3)'
                          cardBorder = '#FCA5A5'
                        } else if (progress.pct > 0) {
                          cardBg = 'rgba(238,242,255,0.3)'
                          cardBorder = '#C7D2FE'
                        }
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  color: iconColor,
                                  boxShadow:
                                    progress.pct > 0 && !isCompleted
                                      ? '0 4px 12px rgba(88,80,236,0.2)'
                                      : 'none',
                                }}
                              >
                                {icon}
                            ...
                            >
                              ...
                              >
                                {isCompleted ? '✅' : '⭐'}{' '}
                                {isCompleted
                                  ? `+${progress.total * 10} Poin Didapat`
                                  : `+${Math.round(progress.total * 10 * (1 - progress.pct / 100))} Poin`}
                              </span>
                              {isCompleted ? (
                                <button
                                  type='button'
              ...
              <section
                style={{
                  ...
                  justifyContent: 'space-between',
                  gap: 24,
                  boxShadow: '0 16px 40px -8px rgba(88,80,236,0.3)',
                }}
              >
                <div>
                  <span
                  ...
                  >
                    Cerdas Cermat Sains Antar Kelas
                  </h2>
                  <p
                    style={{
                      fontSize: 12,
                  ...
                  >
                    Ajak temanmu bersaing secara live setiap hari Jumat pukul
                    16.00 WIB. Dapatkan lencana langka & medali kehormatan!
                  </p>
                </div>
                <button
                  type='button'
                        ...
                        >
                          <div
                            style={{
                              height: '100%',
                              width: `${progress.pct}%`,
                              background: isCompleted ? '#059669' : '#5850EC',
                              borderRadius: 999,
                            }}
                          />
                        </div>
                        ...
                        >
                          ...
                          >
                            <div
                              style={{
                                height: '100%',
                                width: `${getAssignmentProgress(a).pct}%`,
                                background: '#5850EC',
                                borderRadius: 999,
                              }}
                            />
              ...
              >
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontWeight: (item as any).fw || 600,
                        fontSize: 13,
                        color: (item as any).c || '#0f172a',
                      }}
                    >
                      {item.v}
                    </span>
        ...
        {sideTab === 'home' && (
          ...
          >
            ...
            <div
              style={{
                borderRadius: 24,
                background: 'linear-gradient(135deg, #FF6B4A 0%, #FFA14A 100%)',
                padding: 24,
                color: '#fff',
                position: 'relative',
                overflow: 'hidden',
                boxShadow: '0 12px 32px -8px rgba(255,107,74,0.3)',
              }}
            >
              <div
                style={{
              ...
              >
                Kumpulkan bintang setiap hari untuk membuka skin avatar spesial
                dan bonus koin belajar.
              </p>
              <button
                type='button'
                style={{
            ...
            >
              ...
              >
                {(subjectBreakdown.length > 0
                  ? subjectBreakdown
                  : [
                      { name: 'Math', pct: 78, color: '#6366f1' },
                      { name: 'Science', pct: 65, color: '#f43f5e' },
                      { name: 'Indo', pct: 88, color: '#f59e0b' },
                    ]
                ).map((s, i) => (
                  <div
                    key={i}
            ...
            >
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 18, fontWeight: 800, color: '#f43f5e' }}
                  >
                    {overdueCount}
                  </div>
                  <div
                ...
                >
                  <div
                    style={{ fontSize: 18, fontWeight: 800, color: '#5850EC' }}
                  >
                    {inProgressCount}
                  </div>
                  <div
